    ...
    <nav class="sidebar-menu">
      <template v-for="item in menuItems" :key="item.key">
        ...
        <RouterLink v-else :to="item.path" class="sidebar-item" :class="{ active: isActiveMenu(item) }">
          ...
          <em v-if="item.featured && !collapsed" class="sidebar-svg-fire" aria-hidden="true">
            <svg viewBox="0 0 125 190" xmlns="http://www.w3.org/2000/svg">
              <path class="sidebar-flame-main" fill="#F36E21"
              ...
              <path class="sidebar-flame-main one" fill="#F6891F"
              ...
              <path class="sidebar-flame-main two" fill="#FFD04A"
              ...
              <path class="sidebar-flame-main three" fill="#FDBA16"
              ...
              <path class="sidebar-flame-main four" fill="#F36E21"
