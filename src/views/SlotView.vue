    ...
    <section class="home-game-showcase">
        <div class="showcase-topbar">
            <div class="showcase-topbar-left">
                ...
                <div class="showcase-provider">
                    <img src="/images/providers/PG-logo-light.png" alt="PG Logo" class="showcase-provider-logo" />
        ...
        <Transition :name="transitionName" mode="out-in">
            <div :key="pageIndex" class="showcase-grid">
                <article v-for="game in visibleGames" :key="game.id" class="showcase-game-card">
                    <img :src="getGameImage(game)" :alt="t(game.titleKey)" class="showcase-game-img" />
        ...
        <div v-if="totalPages > 1" class="showcase-carousel-dots">
            <button type="button" class="showcase-dot-nav" :disabled="pageIndex === 0" @click="prevPage">
                <i class="bi bi-chevron-left"></i>
            </button>

            <button v-for="page in totalPages" :key="page" type="button" class="showcase-dot"
                :class="{ active: pageIndex === page - 1 }" @click="goToPage(page - 1)"></button>

            <button type="button" class="showcase-dot-nav" :disabled="pageIndex === totalPages - 1" @click="nextPage">
                <i class="bi bi-chevron-right"></i>
            </button>
        </div>
    </section>
